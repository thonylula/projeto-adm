            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200">
                ...
                <div className="p-8 space-y-4">
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-[#F97316] text-white font-black rounded-2xl shadow-2xl shadow-[#F97316]/20 hover:bg-[#EA580C] transition-all active:scale-95 mt-8 uppercase tracking-[0.2em] text-xs"
                    >
