        ...
        >
            ...
            <div className="p-1 px-2 border-b-2 flex justify-between items-center" style={{ borderColor: '#f97316', borderBottom: '2px solid #f97316' }}>
                <div className="space-y-0.5">
                    <h1 className="text-lg font-black uppercase text-slate-900 leading-none">{companyName || data.recipientName}</h1>
                    <p className="text-xs text-slate-600 font-extrabold leading-tight">CNPJ: {data.recipientCnpj || '---'}</p>
                </div>
                <div className="text-right">
                    <p className="text-sm font-black text-slate-800 leading-tight">Data: {data.issueDate || '---'}</p>
                </div>
            </div>
