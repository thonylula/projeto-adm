                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 animate-in slide-in-from-top-4 duration-300">
                    ...
                    <form onSubmit={handleSave} className="space-y-4">
                        ...
                        <div className="pt-4 flex gap-3 justify-end">
                            ...
                            <button type="submit" className={`px-6 py-2 text-white font-bold rounded-lg shadow-md ${
                                activeType === 'EMPLOYEE' ? 'bg-indigo-600 hover:bg-indigo-700' : 
                            ...
                            <tr key={cli.id} className="hover:bg-gray-50 group">
                                <td className="px-6 py-4">
                                    ...
                                    <span className={`inline-block px-2 py-0.5 rounded text-[10px] font-bold ${
                                        cli.status === 'ACTIVE' ? 'bg-green-100 text-green-700' : 
